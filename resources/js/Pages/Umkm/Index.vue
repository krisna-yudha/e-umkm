                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-2xl border border-gray-200">
                    <div class="p-8 text-gray-900">
                        <div v-if="umkms.length === 0" class="text-center py-16">
                            <div class="mb-8">
                                <div class="mx-auto w-28 h-28 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full flex items-center justify-center mb-6">
                        ...
                        <div v-else>
                            <div class="mb-4">
                                <h3 class="text-lg font-semibold text-gray-900">📋 Daftar UMKM Anda</h3>
                            </div>
                            <div class="space-y-4">
                                <div
                                    v-for="umkm in umkms"
                                    ...
                                    class="group bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden hover:shadow-lg hover:border-blue-300 transition-all duration-300 cursor-pointer relative"
                                >
                                    ...
                                    <div class="absolute top-3 right-3 z-10">
                                        <span 
                                            ...
                                            class="inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full border shadow-sm"
                                        >
                                            <div :class="{
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:items-center p-3 sm:p-4">
                                        <!-- Image Section -->
                                        <div class="w-20 h-20 sm:w-24 sm:h-24 flex-shrink-0 mx-auto sm:mx-0 sm:mr-4 mb-3 sm:mb-0">
                                        ...
                                        <div class="flex-1 min-w-0 text-center sm:text-left">
                                            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2">
                                                <div class="mb-1 sm:mb-0">
                                                    <h3 class="text-base sm:text-lg font-bold text-gray-900 truncate mb-1 group-hover:text-blue-600 transition-colors duration-200">{{ umkm.nama_umkm }}</h3>
                                                </div>
                                            </div>
                                            
                                            <div class="flex flex-col space-y-1 mb-3 sm:mb-0">
                                        ...
                                        <!-- Action Buttons -->
                                        <div class="flex-shrink-0 flex justify-center sm:ml-4 mt-3 sm:mt-0" @click.stop>
                                            <div class="flex items-center space-x-3">
                                                <!-- Edit Button -->
                                                <Link
                                                    :href="route('umkm.edit', umkm.id)"
                                                    class="inline-flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 transition-all duration-200 shadow-md hover:shadow-lg"
                                                    title="Edit UMKM"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    class="inline-flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200 shadow-md hover:shadow-lg"
                                                ...
                                                <button
                                                    ...
                                                    class="inline-flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 bg-red-500 text-white rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-all duration-200 shadow-md hover:shadow-lg"
                                                    title="Hapus UMKM"
                                                >
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
